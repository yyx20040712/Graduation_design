"""OCR for Volume 6-11: 水处理/生活垃圾/路灯/钢筋/拆除/措施"""
import os, time, json
...
vol_path = Path(r'D:\python_code\Graduation_design\docs\2019年版黑龙江省市政工程消耗量定额--第六册水处理工程 第七册：生活垃圾处理工程 第八册：路灯工程 第九册：钢筋工程  第十册：拆除工程 第十一册 措施项目')
output_dir = Path(r'D:\python_code\Graduation_design\.sisyphus\notepads\pdf-knowledge\ocr_output\vol6_水处理等')
